...
class BaseInfraStack extends Stack {
    constructor(scope, id, props) {
        ...
        // domain and routes
        const hostedZone = aws_route53.HostedZone.fromHostedZoneId(this, "looplend-hostedzone","Z0900996Z934SE0YJTO8");
        ...
        const devWebsiteBucket = new aws_s3.Bucket(
            ...
            'looplend-website-dev',
            {
                ...
                blockPublicAccess: aws_s3.BlockPublicAccess.BLOCK_ACLS,
                accessControl:
                    aws_s3.BucketAccessControl.BUCKET_OWNER_FULL_CONTROL,
            }
        )
